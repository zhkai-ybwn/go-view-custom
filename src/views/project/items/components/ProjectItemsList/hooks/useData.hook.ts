...
import { projectListApi, deleteProjectApi, changeProjectReleaseApi, duplicateProjectApi } from '@/api/path'
...
export const useDataListInit = () => {
  ...
  const copyHandle = async (cardData: Chartype) => {
    const res = await duplicateProjectApi({ projectId: cardData.id })
