<template>
  <collapse-item name="组件联动" :expanded="true">
    <setting-item-box name="联动开关" :alone="true">
      <setting-item>
        <n-space>
  ...
  <collapse-item name="信息" :expanded="true">
    ...
    <setting-item-box name="数值" :alone="true">
      <setting-item>
        <n-input v-model:value="optionData.dataset" type="textarea" size="small"></n-input>
      </setting-item>
    </setting-item-box>
    <setting-item-box name="单位" :alone="true">
      <setting-item>
        <n-input v-model:value="optionData.unitText" type="textarea" size="small"></n-input>
      </setting-item>
    </setting-item-box>
  </collapse-item>
</template>
